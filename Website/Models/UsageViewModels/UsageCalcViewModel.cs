...
namespace MyVoltage.Models.UsageViewModels
{
    ...
    public class UsageCalcLinkedAssetItem : UsageCalc_LinkedAsset
    {
        public UsageCalc_Asset UsageCalc_Asset { get; set; }
    ...
    public class UsageCalcViewModel
    {
        ...
        public List<UsageCalc> UsageCalcs { get; set; }
    ...
    public class UsageCalcCreateModel
    {
        ...
        public List<UsageCalc_Asset> UsageCalc_Assets { get; set; }
    ...
    public class UsageCalcEditModel
    {
        public Customer Customer { get; set; }
        public UsageCalcMeterItem Meter { get; set; }
        public UsageCalc UsageCalc { get; set; }
