...
namespace MyVoltage.Data
{
    ...
    public class E01_BuildingOnboardingTask
    {
        [Key]
    ...
    public class E01_BuildingOnboardingTasks_ReassignLog
    {
        [Key]
        public int ID { get; set; }
    ...
    public class E01_BuildingOnboardingTask_Type
    {
        [Key]
        public int ID { get; set; }
    ...
    public class E01_BuildingOnboardingTask_Type_Company
    {
        [Key]
        public int ID { get; set; }
        public int TaskTypeID { get; set; }
    ...
    public class E01_BuildingOnboardingTasks_Attachment
    {
        [Key]
        public int ID { get; set; }
        public int TaskID { get; set; }
