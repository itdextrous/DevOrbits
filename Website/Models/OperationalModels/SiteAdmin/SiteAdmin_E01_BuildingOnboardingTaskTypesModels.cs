...
namespace MyVoltage.Models.OperationalModels.SiteAdmin.SiteAdmin_E01_BuildingOnboardingTaskTypesModels
{
    public class SiteAdmin_E01_BuildingOnboardingTask_TypesModel
    {
        public bool ShowDeleted { get; set; }
        public List<SiteAdmin_E01_BuildingOnboardingTaskTypesItem> SiteAdmin_E01_BuildingOnboardingTaskTypesItems { get; set; }

        public class SiteAdmin_E01_BuildingOnboardingTaskTypesItem : Data.E01_BuildingOnboardingTask_Type
        {
    ...
    public class SiteAdmin_E01_BuildingOnboardingTask_TypesAddModel
    {
    ...
    public class SiteAdmin_E01_BuildingOnboardingTask_TypesEditModel
    {
        public Data.E01_BuildingOnboardingTask_Type E01_BuildingOnboardingTask_Type { get; set; }
        public List<Data.E01_BuildingOnboardingTask_Type_Company> E01_BuildingOnboardingTask_Type_Companies { get; set; }
